...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    // Sampling is hardcoded to Qwen3.5-0.8B recommended params (see common.h).
    add_opt(common_arg(
        {"--greedy"},
        "deterministic greedy decoding (argmax, no penalties)",
        [](common_params & params) {
            ...
            params.sampling.penalty_last_n  = 0;
        }
    ).set_sparam());
    add_opt(common_arg(
